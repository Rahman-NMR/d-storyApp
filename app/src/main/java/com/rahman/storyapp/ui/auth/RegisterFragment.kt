...
class RegisterFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnActionRegister: Button = view.findViewById(R.id.action_register)
    ...
    override fun onClick(view: View?) {
        ...
        val progressIndicator = requireActivity().findViewById<CircularProgressIndicator>(R.id.progress_auth)

        if (view?.id == R.id.action_register) {
